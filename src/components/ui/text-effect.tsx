...
const staggerTimings: Record<PerType, number> = {
  char: 0.03,
  word: 0.05,
  line: 0.1,
};
...
export function TextEffect({
  ...
  const stagger = staggerTimings[per];

  const containerVisible = containerVariants.visible as TargetAndTransition;
  ...
  const computedContainerVariants: Variants = {
    ...
    visible: {
      ...
      transition: {
        ...
        staggerChildren:
          containerVisible?.transition?.staggerChildren || stagger,
        delayChildren: delay,
      },
    },
